...
- [ ] Un grand livre « poids dérivants » : une ligne reconduite garde sa valeur ; seules
      les entrantes se partagent les liquidités libérées par les sortantes, à parts égales
      entre elles.
- [ ] Comparaison contre le grand livre équipondéré sur 2004-2026 : capital final,
      croissance/an, pire baisse, épisodes < −20 %.
- [ ] Un chiffre unique en points de croissance annuelle, inscrit à la clause Pondération
      du protocole, avec la date de mesure.
- [ ] Si l'écart dépasse ~0,5 pt/an : décision explicite de Jean (redimensionner en vrai,
      ou accepter l'écart).
