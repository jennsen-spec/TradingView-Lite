...
**Statut** : 🔍 Affiné · **Points** : 13 · **Catégorie** : 💼 Portefeuille · **Taille** : XL
...
- [ ] Frais **0,35 % aller-retour** appliqués sur la **rotation réelle**.
- [ ] Le protocole de référence (momentum 12-1, décile supérieur, mensuel) **reproduit les chiffres de Cowork à la marge d'erreur près** — sinon on cherche pourquoi avant d'aller plus loin.
