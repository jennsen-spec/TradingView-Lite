...
1. **#84 Coquille mobile** — rupture d'écran, onglets bas, bascule Watchlist → Graphique. *Sprintable sans le design.*
2. **#85 Watchlist mobile** — collections parcourables en haut, sous-catégories, liste tactile.
3. **#86 Graphique mobile v1 (consultation)** — barre du bas, bottom sheets (indicateurs, dessins en gestion lecture seule), empilement « ^ ».
4. **#87 Interactions fines** — overlays de scroll symbole/intervalle, menu « ⋯ », icônes défilantes.
5. **#88 PWA (bonus)** — manifest + service worker : icône écran d'accueil, plein écran.
