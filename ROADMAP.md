...
| [**79**](docs/backlog/79-duo-mom-phase2-append.md) | **DUO.MOM phase 2** — append mensuel (backtest → live) | 💼 | 5 | M | | 🔍 | L'Action rapport ajoute chaque mois un point (rendement réalisé du panier) → DUO.MOM **public auto-actualisé**. Inverse la garde local-only de #77 (assumé), étiquette « non validé » conservée. Dépend de #77. |
