...
| 94 | **Fiche backtest d'un titre** | 💼 | ? | — | *À affiner.* Prendre un titre — réel ou synthétique — et afficher ses informations de backtest. **Recoupe #82 et #83 juste en dessous** : à cadrer ensemble avant de sprinter, sinon on construit trois fois la même chose. |
