...
|---|------|:---:|:---:|:---:|:---:|---|---|
| 90 | **Pastille « nouveau rapport »** | 🧩 | 3 | S | | 🧪 À valider | [ticket](docs/backlog/90-pastille-nouveau-rapport.md). Pastille sur l'onglet Rapport à chaque publication mensuelle, éteinte à la première consultation. Notification iOS **reportée à l'espace membre** (#24). |
