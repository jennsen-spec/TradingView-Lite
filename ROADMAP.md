...
| [**64**](docs/backlog/64-selection-multiple.md) | **Sélection multiple : tout sélectionner, couper/coller, édition groupée** | 🧩 | 5 | M | | 🏗️ | Clic droit « Sélectionner tout », couper (Ctrl+X), coller en place après un couper, paramètres communs modifiables en lot. Presse-papier limité au symbole. |
