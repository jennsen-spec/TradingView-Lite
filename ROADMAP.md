...
- **Épopée #70 (responsive)** : [#84](docs/backlog/84-coquille-mobile.md) Coquille mobile (rupture 900 px, onglets bas) · [#89](docs/backlog/89-onglet-rapport-mobile.md) Onglet « Rapport » mobile · [#85](docs/backlog/85-watchlist-mobile.md) Watchlist mobile (chips, overlay Graphique/Backtest) — UAT iPhone 02/09.
